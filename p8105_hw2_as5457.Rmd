...
The number of observations in the trashwheel dataset is `r nrow (trash_wheel)`. The number of observations in the merged precipitation dataset is `r nrow (combined_year)`. The key variables are CLEANUP. The median number of sports balls in a dumpster in 2016 was `r median(trash_wheel$sports_balls)`.
